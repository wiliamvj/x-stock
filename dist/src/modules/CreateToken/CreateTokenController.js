...
var CreateTokenController = /** @class */ (function () {
    function CreateTokenController() {
    }
    CreateTokenController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, token;
            return __generator(this, function (_b) {
                _a = req.body, name = _a.name, email = _a.email;
                if (!name || !email) {
                    throw new Error('name or email not found!');
                }
                token = (0, jsonwebtoken_1.sign)({ email: email }, process.env.TOKEN_AUTH || '', {
                    subject: name,
                    expiresIn: '50d'
                });
