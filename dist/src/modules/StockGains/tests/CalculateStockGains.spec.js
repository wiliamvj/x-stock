...
describe('Search gains quote', function () {
    it('I hope the user receives a gains quotes', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1["default"])(app_1.app)
                        ...
                        .query({
                        purchasedAt: (0, moment_1["default"])().subtract(5, 'days').format('YYYY-MM-DD'),
                        purchasedAmount: 5
                    })];
                case 1:
                    res = _a.sent();
...
//# sourceMappingURL=CalculateStockGains.spec.js.map